...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tBLendController.do?doAdd" tiptype="4">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				<td align="right"><label class="Validform_label"> isbn:
				</label></td>
				<td class="value" nowrap><input name="bookid" type="hidden" value="${id}" id="bookid"> <input name="isbn" class="inputxt" value="${isbn }" id="isbn"
			...
			<span class="Validform_checktip"></span></td>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="bookname" name="bookname" type="text" readonly="readonly" style="width: 150px" class="inputxt"  
			...
			<tr>
				<td align="right"><label class="Validform_label"> 读者编号:
				</label></td>
				<td class="value" nowrap> <input name="userName" class="inputxt" value="${userName }" id="userName"
			...
			<tr>
					...
					<td class="value">
					     	 <input id="realName" name="realName" readonly="readonly" type="text" style="width: 150px" class="inputxt"  
								               >
							<span class="Validform_checktip"></span>
