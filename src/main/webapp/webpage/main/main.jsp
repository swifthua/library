...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/login.png;"> </td>
		...
		<table>
			<tr>
				...
				<td valign="top" height="50"><span style="color: #CC33FF">余额:</span><span style="color: #666633">(${debit }) <span style="color: #CC33FF">职务</span>:<span style="color: #666633">${roleName
				}</span></td>
			</tr>
			<td>
