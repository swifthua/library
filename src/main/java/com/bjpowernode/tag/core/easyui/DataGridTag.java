package com.bjpowernode.tag.core.easyui;
...
import com.bjpowernode.core.util.ApplicationContextUtil;
...
import com.bjpowernode.tag.vo.easyui.ColumnValue;
import com.bjpowernode.tag.vo.easyui.DataGridColumn;
import com.bjpowernode.tag.vo.easyui.DataGridUrl;
import com.bjpowernode.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
	...
	public String getNoAuthOperButton(){
		...
		com.bjpowernode.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
