...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		com.bjpowernode.core.util.LogUtil.info("明文:" + str);
		com.bjpowernode.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(str, password, salt);
			com.bjpowernode.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			com.bjpowernode.core.util.LogUtil.info("明文:" + plaintext);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
