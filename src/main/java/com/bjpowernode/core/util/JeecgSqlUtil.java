...
import com.bjpowernode.core.def.ConstantsDefs;
...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		com.bjpowernode.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		com.bjpowernode.core.util.LogUtil.info(sqlurl);
...
//		 com.bjpowernode.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		com.bjpowernode.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		// com.bjpowernode.core.util.LogUtil.info(getAppPath(JeecgSqlUtil.class));
		com.bjpowernode.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
