...
import com.bjpowernode.core.util.ImportUtil;
import com.bjpowernode.core.util.JSONHelper;
...
import com.bjpowernode.tag.vo.easyui.Autocomplete;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), " com.bjpowernode.web.system.pojo.base.TSAttachment");
