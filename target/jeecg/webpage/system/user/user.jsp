...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
     ...
     ${user.userName }
		...
		<tr>
			<td align="right" nowrap><label class="Validform_label"> 余额: </label></td>
			<td class="value"><input class="inputxt" name="debit" value="${user.debit}" datatype="numrange" min="0" max="100" errormsg="金额不正确!" ignore="ignore"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
